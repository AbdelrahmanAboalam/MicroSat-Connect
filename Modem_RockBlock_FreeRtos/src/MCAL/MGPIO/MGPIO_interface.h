...
date		: 18/4/2024
version		: 1.2.0
description : MGPIO_interface.h -> functions prototypes
...
/********************************************************************************************/
/* @Name  	  :->		@ MGPIO_voidSetAltFunc  								    		*/
/* @Brief 	  :->		@ used to Set the Alternative functions 						 	*/
/* @parameters   :-> 	@ Copy_u8Port: PORT NAME										    */
/*						@ Copy_u8pin : Number of pin                     				    */
/*                      @  Copy_u8AltValue : the lin of AF                                  */
/* @PreRequsteis :->	@ the Peripheral clock must be enabled in the RCC AHB1				*/
/********************************************************************************************/
